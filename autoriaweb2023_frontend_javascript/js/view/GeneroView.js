...
// título para Nome_Genero
function renderizarFormularioGenero() {
    return `
            <form class="mt-3" id="formulario_Genero">
                <div class="form-group">
                    <label for="Genero_Nome_Genero">Título do Genero:</label>
                    <input type="text" class="form-control" id="Genero_Nome_Genero_formulario"> 
                </div>
  ...
  function renderizarFormularioGeneroAtualizar(Genero) {
      return `
              <form class="mt-3" id="formulario_Genero_atualizar">
                  ...
                  <div class="form-group">
                      <label for="Genero_Nome_Genero">Título do Genero:</label>
                      <input type="text" class="form-control" id="Genero_Nome_Genero_formulario" value="${Genero.Nome_Genero}">
                  </div>
                  <button type="submit" class="btn btn-primary mt-2">Salvar</button>
              </form>
          `;
