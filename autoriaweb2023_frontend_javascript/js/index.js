...
import EstudioController from "./controller/EstudioController.js";
...
$("#estudio").addEventListener("click", function() {
  fecharNavBar();
  EstudioController.renderizarEstudioFormulario(componentePrincipal);
});

$("#lista_estudio").addEventListener("click", function() {
  fecharNavBar();
  EstudioController.renderizarListaEstudio(componentePrincipal);
});
